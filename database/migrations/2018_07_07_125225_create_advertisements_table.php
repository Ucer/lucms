...
class CreateAdvertisementsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('advertisements', function (Blueprint $table) {
            ...
            $table->string('name',20)->default('')->comment('广告标题');
            ...
            $table->string('link_url',255)->default('')->comment('跳转 url:为空则不跳转');
            $table->string('model_column_value',100)->default('')->comment('json_encode([model=>article,column=>slug,value=markdown-language)');
